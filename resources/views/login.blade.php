...
<body>
    <div>
    <h1 align="center">欢迎登录熊虎健身俱乐部</h1>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">如果没有帐号，欢迎<a class="btn btn-primary" href="{!! url('sign') !!}">注册</a></h3>
                    </div>
                    <div class="panel-body">
                        {!! Form::open(['url' => 'check', 'role' => 'form']) !!}
                            <fieldset>
